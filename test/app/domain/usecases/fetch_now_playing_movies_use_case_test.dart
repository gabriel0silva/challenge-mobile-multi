...
void main() {
  ...
  late FetchNowPlayingMoviesUseCase mockFetchNowPlayingMoviesUseCase;
  ...
  setUp(() {
    ...
    mockFetchNowPlayingMoviesUseCase = FetchNowPlayingMoviesUseCase(mockRepository);
  });
  ...
  group('FetchNowPlayingMoviesUseCase', () {
    ...
    test('call returns MoviesModel when repository returns data', () async {
      ...
      when(() => mockRepository.fetchNowPlayingMovies()).thenAnswer((_) async => moviesModel);

      final result = await mockFetchNowPlayingMoviesUseCase.call();
    ...
    test('call returns null when repository returns null', () async {
      when(() => mockRepository.fetchNowPlayingMovies()).thenAnswer((_) async => null);
